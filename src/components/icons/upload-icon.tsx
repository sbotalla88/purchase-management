export const UploadIcon = ({ color = 'currentColor', width = '41px', height = '30px', ...rest }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 40.909 30" {...rest}>
