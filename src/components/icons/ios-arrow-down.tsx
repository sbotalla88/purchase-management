...
export const IosArrowDown = ({ color = 'currentColor', width = '7px', height = '10px', ...props }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 7 10" {...props}>
            <path
