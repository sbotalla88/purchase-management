...
export const ArrowDown = ({ color = 'currentColor', width = '12px', height = '12px', ...props }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 11.996 12" {...props}>
            <path
                data-name="Path 2462"
