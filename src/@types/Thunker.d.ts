...
declare type ThunkAction<ReturnType, State, ExtraThunkArg, BasicAction extends Action> = (
...
declare module 'redux' {
    ...
    function bindActionCreators<ActionCreators extends ActionCreatorsMapObject<any>>(
        ...
        [ActionCreatorName in keyof ActionCreators]: ReturnType<ActionCreators[ActionCreatorName]> extends ThunkAction<
            any,
            any,
            any,
            any
